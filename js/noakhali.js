...
document.getElementById('donate-noakhali').addEventListener('click',function(event){
    ...
    const donation_balance=parseFloat(getInputFieldValueById('input-amount-noakhali'));
    const total_balance=parseFloat(getAttributeValueById('balance-noakhali'));
    ...
    setAttributeValueById('balance-noakhali',total_balance+donation_balance);
    setAttributeValueById('balance-main',main_balance-donation_balance);

    //add to history
    const head=getAttributeValueById('donate-noakhali-heading');
